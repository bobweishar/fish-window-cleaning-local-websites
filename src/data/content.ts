...
export const services: ServicePage[] = [
  {
    ...
    heroImage: '/images/jobs/4312.webp',
    ...
    scope: [
      ...
      { title: 'Details + add-ons', copy: 'Add screens, tracks, sills, skylights, gutters, or exterior fixtures to the quote.' },
    ],
    featureHeading: 'Careful work around your home.',
    featureImage: '/images/jobs/4260.webp',
    featureAlt: 'Uniformed FISH team member cleaning an exterior coach light',
    checks: ['Uniformed professionals', 'Background-checked team members', 'Protection for interior work', 'Free on-site quote'],
    localHeading: 'Different homes call for different work.',
    localCopy: 'Older windows and divided panes need a different approach than tall entries, broad glass, or landscaped access. The team confirms the method during the quote.',
    localImage: '/images/jobs/4305.webp',
    ...
    faqs: [
      ...
      { question: 'Can you clean screens, tracks, or skylights?', answer: 'Yes. Add them to the quote so they appear in the written scope.' },
      { question: 'What happens if weather changes the plan?', answer: 'The team will contact you if conditions affect the appointment.' },
      { question: 'Do you also clean gutters or exterior fixtures?', answer: 'Yes. Ask about both with your window-cleaning quote.' },
    ],
  ...
  },
  {
    ...
    heroImage: '/images/jobs/4542.webp',
    ...
    featureImage: '/images/jobs/4382.webp',
    ...
    localCopy: 'Road film, salt, fingerprints, and weather show quickly on storefront glass. The quote covers access, operating hours, and frequency.',
    localImage: '/images/jobs/4486.webp',
    localAlt: 'Red FISH van outside a Chicago-area commercial job in winter',
    faqs: [
      { question: 'Can service happen around business hours?', answer: 'Yes. Share your hours and access needs during the quote.' },
      { question: 'Can you provide recurring service?', answer: 'Yes. The quote confirms the property and frequency.' },
      { question: 'What information helps with a quote?', answer: 'Property address, number of stories, interior or exterior scope, preferred frequency, operating hours, and access requirements.' },
  ...
  },
  {
    ...
    heroCopy: 'Seasonal gutter cleaning for homes under mature trees. The quote confirms roofline, access, and included runs.',
    heroImage: '/images/jobs/4504.webp',
    ...
    featureCopy: 'The quote confirms roofline, access, and the gutter runs included in the job.',
    featureImage: '/images/jobs/4503.webp',
    featureAlt: 'Before and after photographs of a gutter cleaned by the local FISH team',
    checks: ['Free on-site quote', 'Scope confirmed before work', 'Local uniformed crew', 'Window-cleaning add-on available'],
    ...
    faqs: [
      ...
      { question: 'Can I combine gutters and windows?', answer: 'Yes. Ask for both when requesting the quote so the team can review the combined scope.' },
      { question: 'Do you clean every roofline?', answer: 'Access and building height are confirmed during the quote.' },
  ...
  },
  {
    ...
    heroCopy: 'The quote accounts for material, buildup, brick or stone details, landscaping, and access.',
    heroImage: '/images/jobs/4101.webp',
    ...
    featureCopy: 'The team confirms the surface, condition, method, and availability during the quote.',
    featureImage: '/images/jobs/4066.webp',
    featureAlt: 'Local FISH team pressure washing an exterior surface',
    checks: ['Surface-specific quote', 'Local uniformed crew', 'Clear written scope', 'Exterior service coordination'],
    localHeading: 'Four seasons leave buildup behind.',
    localCopy: 'Road film, shade, moisture, and weather affect each surface differently. The quote keeps the recommendation specific to the property.',
    localImage: '/images/jobs/4280.webp',
    ...
    faqs: [
      ...
      { question: 'Can pressure washing be combined with windows?', answer: 'Yes. Include both services in the quote request so sequencing and scope can be planned together.' },
      ...
      { question: 'Will every stain come out?', answer: 'Results vary by surface, age, and the type of buildup. The team will set expectations during the quote.' },
    ],
...
export const areas: AreaPage[] = [
  {
    ...
    noteCopy: 'Ask about windows, gutters, fixtures, and approved exterior surfaces in one quote.',
    faqs: [
      { question: 'Can you work with divided panes or older windows?', answer: 'Point out the window type during the quote so the team can review construction, condition, and access.' },
      { question: 'Can I combine windows and gutters?', answer: 'Yes. Ask for both in the quote so the team can review the combined scope.' },
  ...
  },
  {
    ...
    details: [
      ...
      { title: 'Business glass runs on a schedule.', copy: 'Offices, showrooms, restaurants, and customer-facing entries can be quoted for one-time or recurring service.' },
    ],
    ...
    faqs: [
      { question: 'Do you clean large residential properties?', answer: 'Yes. The quote confirms the glass, access, interior scope, and time required.' },
      { question: 'Is recurring commercial service available?', answer: 'Yes. The quote confirms the property and frequency.' },
      { question: 'Can I request windows and gutters together?', answer: 'Yes. Include both in the quote request.' },
  ...
  },
  {
    ...
    details: [
      { title: 'More glass changes the job.', copy: 'Tall entries, broad window walls, specialty panes, and landscaped access all belong in the quote.' },
    ...
    faqs: [
      { question: 'Can you clean tall or difficult windows?', answer: 'The team reviews access and the appropriate method during the quote.' },
      ...
      { question: 'Can gutters be added?', answer: 'Yes, subject to property access and the confirmed quote.' },
  ...
  },
  {
    ...
    faqs: [
      { question: 'Can you clean older or divided-light windows?', answer: 'Yes. Show the team the window type during the quote so the correct scope can be prepared.' },
      { question: 'Do you serve La Grange storefronts?', answer: 'Yes. The quote confirms the property and frequency.' },
      ...
      { question: 'Is the quote free?', answer: 'Yes. The local franchise provides free on-site quotes.' },
    ],
  },
];
...
export const localServices: LocalServicePage[] = [
  {
    ...
    copy: 'Mature trees make timing matter. The quote confirms roofline, access, and included gutter runs before scheduling.',
    image: '/images/jobs/4504.webp', imageAlt: 'Local FISH technician clearing gutters on a suburban home',
    reasons: [
      { title: 'Plan around leaf drop.', copy: 'Book after the heavy fall drop and before freezing weather closes the window.' },
      { title: 'Confirm the roofline.', copy: 'Height, access, and included runs are reviewed at the quote.' },
      { title: 'Combine exterior work.', copy: 'Ask about windows or coach lights during the same quote.' },
    ],
    faqs: [
      ...
      { question: 'Do you clean every home height?', answer: 'The team confirms safe access and scope at the quote.' },
    ],
  ...
  },
  {
    ...
    copy: 'The quote covers tall entries, broad panes, sunrooms, skylights, and interior glass.',
    image: '/images/jobs/4312.webp', imageAlt: 'Local FISH technician cleaning upper-story windows on a brick home',
    reasons: [
      { title: 'Interior + exterior', copy: 'Choose exterior-only service or a complete clean from both sides.' },
      { title: 'Details included by choice', copy: 'Add screens, tracks, sills, skylights, or fixtures to the quote.' },
      { title: 'Care around the home', copy: 'Uniforms, shoe covers, protective pads, and cleanup are part of the local process.' },
    ],
    faqs: [
      { question: 'Can you clean tall residential windows?', answer: 'The team reviews access and method during the on-site quote.' },
...
export const campaigns: CampaignPage[] = [
  {
    ...
    image: '/images/jobs/4305.webp',
    imageAlt: 'Local FISH vans on a tree-lined Chicago suburban street in fall',
    services: [
      { label: 'Window cleaning', href: '/hinsdale/residential-window-cleaning/', copy: 'Interior, exterior, or both before the holidays.' },
      { label: 'Gutter cleaning', href: '/hinsdale/gutter-cleaning/', copy: 'Clear seasonal debris before the first hard freeze.' },
      { label: 'Pressure washing', href: '/hinsdale/pressure-washing/', copy: 'Ask which exterior surfaces are a fit.' },
