...
export const services: ServicePage[] = [
  {
    ...
    title: 'Residential Window Cleaning | Chicago Western & Southern Suburbs',
    description: 'Residential window cleaning from a locally owned FISH franchise serving Hinsdale and Chicago’s western and southern suburbs.',
    heroHeadline: 'More light. Less ladder. A local crew at the door.',
    heroCopy: 'Professional interior and exterior window cleaning for houses, condos, townhomes, sunrooms, skylights, and the glass that is hardest to reach.',
    ...
    localHeading: 'Built for Chicago-suburban homes.',
    localCopy: 'Historic windows, divided panes, mature trees, tall entries, sunrooms, and estate-scale glass all change the work. The team confirms access, scope, and the right method at the estimate.',
  ...
  },
  {
    ...
    title: 'Commercial Window Cleaning | Chicago Western & Southern Suburbs',
    description: 'Commercial window cleaning for storefronts, offices, restaurants, and local businesses from a locally owned FISH franchise.',
    heroHeadline: 'Clean glass before your first customer walks in.',
    heroCopy: 'Reliable one-time or recurring window cleaning for storefronts, offices, restaurants, showrooms, and other local commercial properties.',
    ...
    localHeading: 'Ready for Chicago weather and business hours.',
    localCopy: 'Road film, salt, fingerprints, and seasonal weather show quickly on customer-facing glass. The local team builds the access and timing into the estimate.',
  ...
  },
  {
    ...
    title: 'Gutter Cleaning | Chicago Western & Southern Suburbs',
    description: 'Seasonal gutter cleaning for homes across Chicago’s western and southern suburbs from the local FISH Window Cleaning team.',
    heroHeadline: 'Clear the gutters before Chicago weather tests them.',
    heroCopy: 'Seasonal gutter cleaning for local homes, with the scope and access confirmed before the crew gets to work.',
    ...
    localHeading: 'Made for leaf season around here.',
    localCopy: 'Mature trees are part of what makes the western and southern suburbs feel established. They also make gutter timing matter. Book before the first hard freeze narrows the window.',
    localImage: '/images/jobs/4305.jpg',
  ...
  },
  {
    ...
    title: 'Pressure Washing | Chicago Western & Southern Suburbs',
    description: 'Local pressure washing for approved exterior surfaces across Chicago’s western and southern suburbs.',
    heroHeadline: 'Wash away the season the exterior has been wearing.',
    heroCopy: 'Pressure washing for approved exterior surfaces, estimated around the material, buildup, access, and surrounding property.',
    ...
    localCopy: 'Chicago-area exteriors collect a mix of seasonal residue. A property review keeps the recommendation tied to the actual surface instead of a generic package.',
