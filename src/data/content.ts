...
export const services: ServicePage[] = [
  {
    ...
    localHeading: 'Built for Hinsdale homes.',
    localCopy: 'Historic windows, divided panes, mature trees, tall entries, sunrooms, and larger interiors all change the work. The team confirms access, scope, and the right method at the estimate.',
  ...
  },
  {
    ...
    localHeading: 'Ready for downtown Hinsdale business hours.',
  ...
  },
  {
    ...
    localHeading: 'Made for Hinsdale leaf season.',
    localCopy: 'Mature trees are part of what makes Hinsdale feel established. They also make gutter timing matter. Book before the first hard freeze narrows the window.',
    localImage: '/images/jobs/4305.jpg',
  ...
  },
  {
    ...
    localCopy: 'Hinsdale exteriors collect a mix of seasonal residue. A property review keeps the recommendation tied to the actual surface instead of a generic package.',
